...
INSTALLED_APPS = [
    ...
    'django_daisy', # for admin styling
...
DAISY_SETTINGS = {
    'SITE_TITLE': 'Django Blog Admin',  # The title of the site
    'SITE_HEADER': 'Administration',  # Header text displayed in the admin panel
    'INDEX_TITLE': 'Hi, welcome to the admin ',  # The title for the index page of dashboard
    ...
    'SIDEBAR_FOOTNOTE': 'Developed by paulmbui.co.ke', # add footnote to sidebar
    'APPS_REORDER': {
